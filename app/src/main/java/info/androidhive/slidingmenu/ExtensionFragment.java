...
public class ExtensionFragment extends Fragment implements OnClickListener{
...
Button b1,b2,b3;
	...
	/*	next = (ImageButton) rootView.findViewById(R.id.btNext);
		prev = (ImageButton) rootView.findViewById(R.id.btPrev);
*/
					...
					public void onResponse(JSONArray response) {
						...
						for (int i = 0; i < response.length(); i++) {
							try {
								...
								if (34==obj.getInt("category_id")) {
								Movie movie = new Movie();
								movie.setTitle(obj.getString("name"));
								movie.setThumbnailUrl(obj.getString("image"));
								//movie.setRating(((Number) obj.get("price"))
										// .doubleValue());
